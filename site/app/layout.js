      ...
      <body className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
        <nav className="border-b border-gray-200 dark:border-gray-800">
          <div className="max-w-3xl mx-auto px-6 py-4 flex items-center justify-between">
            <a href="/" className="font-medium text-sm text-gray-900 dark:text-gray-100 hover:text-amber-600 dark:hover:text-amber-400">
              AI Builders Digest
            </a>
            <div className="flex gap-4 items-center text-sm">
              <a href="/archive" className="text-gray-500 dark:text-gray-400 hover:text-amber-600 dark:hover:text-amber-400">
                Archive
              </a>
